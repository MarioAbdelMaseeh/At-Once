...
class SearchRepositoryImpl: SearchRepository{
    ...
    func getProductsByText(area: Int, text: String, page: Int, pageSize: Int, type: String) -> AnyPublisher<[SearchProduct], Error> {
        network.request(_request: SearchAPI.SearchByText(area: area, text: text, page: page, pageSize: pageSize, type: type), responseType: APIResponse<[SearchProductDTO]>.self)
